                            ...
                            <div class="container-fluid shadow-sm ">
                                        ...
                                        <form action="{{ $login_url }}" method="post">
                                            ...
                                            <div class="input-group mb-3">
                                                        ...
                                                        <div class="input-group-append">
                                                            <div class="input-group-text">
                                                                <span class="fab fa-expeditedssl {{ config('adminlte.classes_auth_icon', '') }}"></span>
                                                            </div>
                                                        </div>
                                            ...
                                            <div>
                                                        ...
                                                        <button type=submit class="btn btn-block btn-sm {{ config('adminlte.classes_auth_btn', 'btn-flat') }}">
                                                            Ingresar <span class="fas fa-sign-in-alt"></span>
                                                        </button>
                                                        <br>
                                                        <p> 
