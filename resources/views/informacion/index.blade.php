...
<div class="col-10 card card-purple card-outline shadow">
        ...
        <div class="card-body table-responsive">
                ...
                <div class="callout callout-info alert-dismissable fade show" style="font-weight:bold;">
                            <ol>
                                <li value="1">
                                ...
                                <li value="6">
                                Al terminar de evaluar a todos da click en el botón <span class="badge badge-success">IMPRIMIR COMPROBANTE</span>
                                        <i class="fas fa-mouse-pointer"></i>
                                </li>
                            </ol>
                </div> 
                <div>
                        <a href="{{ route('pages.docentes.index') }}" class="btn btn-outline-success btn-sm">
                            <i class="far fa-hand-point-right"></i>&nbsp;&nbsp;
                            IR A LA EVALUACIÓN AL DESEMPEÑO DEL PERSONAL DOCENTE &nbsp;&nbsp;
